...
import modules.nicknamegen as nicknamegen
...
class RobloxGen:
    ...
    def verify_username(self):
        ...
        nickname = nicknamegen.NicknameGenerator().generate_nickname()
    ...
    def generate_account(self):
        ...
        try:
            ...
            loguru.logger.error("capsolver gives us wrong captcha token..")
            return ""
        userid = resp.json()["userId"]
        loguru.logger.info(f"[https://www.roblox.com/users/{userid}] account created!")
            ...
            if settings_json["verify_mail"]:
                ...
                while True:
                    ...
                    if mailboxdetails["hydra:member"] != []:
                        ...
                        ticketid = re.search("http[s]*\S+", mailcontent["text"])[
                            0
                        ].split("?ticket=")[1]
